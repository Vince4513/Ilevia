                ...
                <div class="row">
                    <div class="profilWindow-col">
                        ...
                        if(isset($_SESSION['id']) AND $userInfo['numu'] == $_SESSION['id']){ 
                            ...
                            <table>
                            	<tr><td><a class='profil-btn' href='achatTickets.php'>Ticket</a></td>
                            	    <td><a class='profil-btn' href='achatAbonnements.php'>Abonnement</a></td>
                            	    <td><a class='profil-btn' href='validation.php'>Validation</a></td>
